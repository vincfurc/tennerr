...
def testEscrowFunction(tennerr, accounts, interface,usdc, tennerrController, tennerrFactory, tennerrEscrow):
    # tuple
...
def testEscrowWithdrawal(tennerr, accounts, interface,usdc, tennerrController, tennerrFactory, tennerrEscrow):
    # tuple
    quotes = tennerr.getQuotesByAddress(accounts[0],{'from': accounts[0]})
    # array
    quote = quotes[0]
